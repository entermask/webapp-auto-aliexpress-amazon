    ...
    case 'ROW_SELECTED':
      {
        ...
        if (state.selectedRows.find(function (r) {
          return r === row;
        })) {
          return _objectSpread2({}, state, {
...
var TableCellCheckbox = function TableCellCheckbox(_ref) {
  ...
  var handleOnRowSelected = function handleOnRowSelected() {
    return dispatch({
      type: 'ROW_SELECTED',
      row: row,
      rows: data
  ...
  var isRowDisabled = row[selectableRowsDisabledField];
...
var TableRow = React.memo(function (_ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(TableRowStyle, {
    ...
    expanded: expanded,
    row: row,
    onExpandToggled: function onExpandToggled() {
...
var DataTable = React.memo(function (_ref) {
  ...
  var _useReducer = React.useReducer(tableReducer, initialState),
      ...
      selectedRowsFlag = _useReducer2$.selectedRowsFlag,
  ...
  var handleChangeRowsPerPage = function handleChangeRowsPerPage(newRowsPerPage) {
    ...
    var recalculatedPage = Math.min(currentPage, updatedPage); // update the currentPage for client-side pagination
  ...
  }, selectableRows && React__default.createElement(TableCol$1, null), expandableRows && React__default.createElement(CellBase, {
    style: {
      flex: '0 0 56px'
    }
